 ...
 * 
 */
public class IU_Registro extends javax.swing.JFrame {

    /**
     * Creates new form IU_Registro
     */
    usuario objUsuario;
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        idusuario = jTextField1.getText();
        nombre = jTextField2.getText();
        nacimiento = jTextField3.getText();
        clave = jTextField4.getText();
        apellido = jTextField5.getText();
        ...
        if (insertar) {
            JOptionPane.showMessageDialog(rootPane, "Se han insertado los usuarios correctamente");
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IU_Registro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IU_Registro().setVisible(true);
            }
        });
    }
